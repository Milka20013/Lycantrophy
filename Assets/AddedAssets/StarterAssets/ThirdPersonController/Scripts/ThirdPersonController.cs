...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        {
            MoveSpeed = playerStats.GetAttributeValue(Attribute.Speed);
        }
        ...
        [Tooltip("Angle to determine slopes")]
        ...
        private void Move()
        {
            ...
            if (OnSlope(out float angle) && Grounded)
            {
                targetDirection = GetSlopeMoveDirection();
            }
            _speed = targetSpeed;
            // move the player
        ...
        private bool OnSlope(out float angle)
        {
        ...
        {
            return Vector3.ProjectOnPlane(targetDirection, slopeHit.normal).normalized;
        }
